#ifdef __BASE_MATRIX3_H__
#ifndef __BASE_MATRIX3_HXX__
#define __BASE_MATRIX3_HXX__
//////////////////////////////////////////////////////////////////////////////
//
//    MATRIX3.HXX
//
...
template<class Type>
_Matrix3<Type>& _Matrix3<Type>::transpose()
{
  set(_00, _10, _20,
      _01, _11, _21,
      _02, _12, _22);
...
template<class Type>
Type _Matrix3<Type>::getDeterminant() const
{
  _Vector3<Type>& row1 = *(_Vector3<Type>*)m[0];
  _Vector3<Type>& row2 = *(_Vector3<Type>*)m[1];
  _Vector3<Type>& row3 = *(_Vector3<Type>*)m[2];

  return _Vector3<Type>::dot(row1, _Vector3<Type>::cross(row2,row3));
}
